...
**Do not start live generation before the quota window has reset** (fact #5 — check `GET /api/tutor/status` quota or the newest rollout file; require used_percent < 50 to start, and re-check between courses).
